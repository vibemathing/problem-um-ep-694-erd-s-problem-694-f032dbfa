...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-694-erd-s-problem-694-f032dbfa-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-694"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-694-erd-s-problem-694-f032dbfa-v1",
      "problem_contract_sha256": "2216e2757041e1f4e86437033c975b487142e68bd508f1c6050022901050f9d0",
      "problem_id": "problem:um-ep-694-erd-s-problem-694-f032dbfa",
      "route_id": "route:um-ep-694-erd-s-problem-694-f032dbfa-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-694-erd-s-problem-694-f032dbfa-source-fidelity-01",
      "graph_id": "graph:um-ep-694-erd-s-problem-694-f032dbfa-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-694-erd-s-problem-694-f032dbfa-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-694-erd-s-problem-694-f032dbfa-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $f_{\\max}(n)$ be the largest $m$ such that $\\phi(m)=n$, and $f_{\\min}(n)$ be the smallest such $m$, where $\\phi$ is Euler's totient function. Investigate $ \\max_{n\\leq x}\\frac{f_{\\max}(n)}{f_{\\min}(n)}. $"
          },
          "statement_sha256": "b57f98c230c742da94d0f7f116f397bf86602ef06a334f6e657e204b0f6ff3ca"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-694-erd-s-problem-694-f032dbfa-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-694-erd-s-problem-694-f032dbfa-root",
      "route_id": "route:um-ep-694-erd-s-problem-694-f032dbfa-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-694-3d5c43efbbf8",
        "url": "https://www.unsolvedmath.com/problems/EP-694"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
